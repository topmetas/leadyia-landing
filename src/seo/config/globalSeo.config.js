...
export const SEO_ROUTES = [
  ...
  { path: "/dentista", priority: "0.9", changefreq: "weekly", playbook: "dentistry" },
  { path: "/veterinaria", priority: "0.9", changefreq: "weekly", playbook: "veterinary" },
  { path: "/contabilidade", priority: "0.85", changefreq: "weekly", playbook: "accounting" },
  { path: "/automotivo", priority: "0.85", changefreq: "weekly", playbook: "automotive" },
  { path: "/restaurante", priority: "0.85", changefreq: "weekly", playbook: "restaurant" },
  { path: "/fitness", priority: "0.85", changefreq: "weekly", playbook: "fitness" },
  { path: "/servicos-residenciais", priority: "0.85", changefreq: "weekly", playbook: "home_services" },
