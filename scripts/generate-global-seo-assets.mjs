...
const routes = [
  ...
  { path: "/dentista", priority: "0.9", changefreq: "weekly" },
  { path: "/veterinaria", priority: "0.9", changefreq: "weekly" },
  { path: "/contabilidade", priority: "0.85", changefreq: "weekly" },
  { path: "/automotivo", priority: "0.85", changefreq: "weekly" },
  { path: "/restaurante", priority: "0.85", changefreq: "weekly" },
  { path: "/fitness", priority: "0.85", changefreq: "weekly" },
  { path: "/servicos-residenciais", priority: "0.85", changefreq: "weekly" },
